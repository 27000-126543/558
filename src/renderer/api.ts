...
export const rideRequestApi = {
  ...
  create: (data: any) => call<RideRequest>(IPC.RIDE_REQUEST.CREATE, data),
  update: (id: number, data: any) => call<RideRequest>(IPC.RIDE_REQUEST.UPDATE, id, data),
  cancel: (id: number) => call<boolean>(IPC.RIDE_REQUEST.CANCEL, id),
...
export const adjustmentApi = {
  ...
  approve: (id: number, approver: string) => call<DriverAdjustment>(IPC.DRIVER_ADJUSTMENT.APPROVE, id, approver),
  reject: (id: number, approver: string) => call<DriverAdjustment>(IPC.DRIVER_ADJUSTMENT.REJECT, id, approver),
};
